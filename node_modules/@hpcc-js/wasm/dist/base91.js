var vn=ArrayBuffer,V=Uint8Array,Ge=Uint16Array,$n=Int16Array,De=Int32Array,er=function(n,i,a){if(V.prototype.slice)return V.prototype.slice.call(n,i,a);(i==null||i<0)&&(i=0),(a==null||a>n.length)&&(a=n.length);var u=new V(a-i);return u.set(n.subarray(i,a)),u},Xe=function(n,i,a,u){if(V.prototype.fill)return V.prototype.fill.call(n,i,a,u);for((a==null||a<0)&&(a=0),(u==null||u>n.length)&&(u=n.length);a<u;++a)n[a]=i;return n},mn=function(n,i,a,u){if(V.prototype.copyWithin)return V.prototype.copyWithin.call(n,i,a,u);for((a==null||a<0)&&(a=0),(u==null||u>n.length)&&(u=n.length);a<u;)n[i++]=n[a++]},wn=["invalid zstd data","window size too large (>2046MB)","invalid block type","FSE accuracy too high","match distance too far back","unexpected EOF"],E=function(n,i,a){var u=new Error(i||wn[n]);if(u.code=n,Error.captureStackTrace&&Error.captureStackTrace(u,E),!a)throw u;return u},Kr=function(n,i,a){for(var u=0,d=0;u<a;++u)d|=n[i++]<<(u<<3);return d},gn=function(n,i){return(n[i]|n[i+1]<<8|n[i+2]<<16|n[i+3]<<24)>>>0},Pn=function(n,i){var a=n[0]|n[1]<<8|n[2]<<16;if(a==3126568&&n[3]==253){var u=n[4],d=u>>5&1,v=u>>2&1,y=u&3,g=u>>6;u&8&&E(0);var P=6-d,j=y==3?4:y,X=Kr(n,P,j);P+=j;var b=g?1<<g:d,C=Kr(n,P,b)+(g==1&&256),W=C;if(!d){var J=1<<10+(n[5]>>3);W=J+(J>>3)*(n[5]&7)}W>2145386496&&E(1);var w=new V((i==1?C||W:i?0:W)+12);return w[0]=1,w[4]=4,w[8]=8,{b:P+b,y:0,l:0,d:X,w:i&&i!=1?i:w.subarray(12),e:W,o:new De(w.buffer,0,3),u:C,c:v,m:Math.min(131072,W)}}else if((a>>4|n[3]<<20)==25481893)return gn(n,4)+8;E(0)},le=function(n){for(var i=0;1<<i<=n;++i);return i-1},ze=function(n,i,a){var u=(i<<3)+4,d=(n[i]&15)+5;d>a&&E(3);for(var v=1<<d,y=v,g=-1,P=-1,j=-1,X=v,b=new vn(512+(v<<2)),C=new $n(b,0,256),W=new Ge(b,0,256),J=new Ge(b,512,v),w=512+(v<<1),H=new V(b,w,v),D=new V(b,w+v);g<255&&y>0;){var F=le(y+1),z=u>>3,O=(1<<F+1)-1,R=(n[z]|n[z+1]<<8|n[z+2]<<16)>>(u&7)&O,p=(1<<F)-1,L=O-y-1,x=R&p;if(x<L?(u+=F,R=x):(u+=F+1,R>p&&(R-=L)),C[++g]=--R,R==-1?(y+=R,H[--X]=g):y-=R,!R)do{var k=u>>3;P=(n[k]|n[k+1]<<8)>>(u&7)&3,u+=2,g+=P}while(P==3)}(g>255||y)&&E(0);for(var M=0,I=(v>>1)+(v>>3)+3,B=v-1,N=0;N<=g;++N){var _=C[N];if(_<1){W[N]=-_;continue}for(j=0;j<_;++j){H[M]=N;do M=M+I&B;while(M>=X)}}for(M&&E(0),j=0;j<v;++j){var m=W[H[j]]++,Y=D[j]=d-le(m);J[j]=(m<<Y)-v}return[u+7>>3,{b:d,s:H,n:D,t:J}]},bn=function(n,i){var a=0,u=-1,d=new V(292),v=n[i],y=d.subarray(0,256),g=d.subarray(256,268),P=new Ge(d.buffer,268);if(v<128){var j=ze(n,i+1,6),X=j[0],b=j[1];i+=v;var C=X<<3,W=n[i];W||E(0);for(var J=0,w=0,H=b.b,D=H,F=(++i<<3)-8+le(W);F-=H,!(F<C);){var z=F>>3;if(J+=(n[z]|n[z+1]<<8)>>(F&7)&(1<<H)-1,y[++u]=b.s[J],F-=D,F<C)break;z=F>>3,w+=(n[z]|n[z+1]<<8)>>(F&7)&(1<<D)-1,y[++u]=b.s[w],H=b.n[J],J=b.t[J],D=b.n[w],w=b.t[w]}++u>255&&E(0)}else{for(u=v-127;a<u;a+=2){var O=n[++i];y[a]=O>>4,y[a+1]=O&15}++i}var R=0;for(a=0;a<u;++a){var p=y[a];p>11&&E(0),R+=p&&1<<p-1}var L=le(R)+1,x=1<<L,k=x-R;for(k&k-1&&E(0),y[u++]=le(k)+1,a=0;a<u;++a){var p=y[a];++g[y[a]=p&&L+1-p]}var M=new V(x<<1),I=M.subarray(0,x),B=M.subarray(x);for(P[L]=0,a=L;a>0;--a){var N=P[a];Xe(B,a,N,P[a-1]=N+g[a]*(1<<L-a))}for(P[0]!=x&&E(0),a=0;a<u;++a){var _=y[a];if(_){var m=P[_];Xe(I,a,m,P[_]=m+(1<<L-_))}}return[i,{n:B,b:L,s:I}]},_n=ze(new V([81,16,99,140,49,198,24,99,12,33,196,24,99,102,102,134,70,146,4]),0,6)[1],Tn=ze(new V([33,20,196,24,99,140,33,132,16,66,8,33,132,16,66,8,33,68,68,68,68,68,68,68,68,36,9]),0,6)[1],jn=ze(new V([32,132,16,66,102,70,68,68,68,68,36,73,2]),0,5)[1],Jr=function(n,i){for(var a=n.length,u=new De(a),d=0;d<a;++d)u[d]=i,i+=1<<n[d];return u},rr=new V(new De([0,0,0,0,16843009,50528770,134678020,202050057,269422093]).buffer,0,36),Cn=Jr(rr,0),tr=new V(new De([0,0,0,0,0,0,0,0,16843009,50528770,117769220,185207048,252579084,16]).buffer,0,53),Fn=Jr(tr,3),He=function(n,i,a){var u=n.length,d=i.length,v=n[u-1],y=(1<<a.b)-1,g=-a.b;v||E(0);for(var P=0,j=a.b,X=(u<<3)-8+le(v)-j,b=-1;X>g&&b<d;){var C=X>>3,W=(n[C]|n[C+1]<<8|n[C+2]<<16)>>(X&7);P=(P<<j|W)&y,i[++b]=a.s[P],X-=j=a.n[P]}(X!=g||b+1!=d)&&E(0)},Sn=function(n,i,a){var u=6,d=i.length,v=d+3>>2,y=v<<1,g=v+y;He(n.subarray(u,u+=n[0]|n[1]<<8),i.subarray(0,v),a),He(n.subarray(u,u+=n[2]|n[3]<<8),i.subarray(v,y),a),He(n.subarray(u,u+=n[4]|n[5]<<8),i.subarray(y,g),a),He(n.subarray(u),i.subarray(g),a)},Wn=function(n,i,a){var u,d=i.b,v=n[d],y=v>>1&3;i.l=v&1;var g=v>>3|n[d+1]<<5|n[d+2]<<13,P=(d+=3)+g;if(y==1)return d>=n.length?void 0:(i.b=d+1,a?(Xe(a,n[d],i.y,i.y+=g),a):Xe(new V(g),n[d]));if(!(P>n.length)){if(y==0)return i.b=P,a?(a.set(n.subarray(d,P),i.y),i.y+=g,a):er(n,d,P);if(y==2){var j=n[d],X=j&3,b=j>>2&3,C=j>>4,W=0,J=0;X<2?b&1?C|=n[++d]<<4|(b&2&&n[++d]<<12):C=j>>3:(J=b,b<2?(C|=(n[++d]&63)<<4,W=n[d]>>6|n[++d]<<2):b==2?(C|=n[++d]<<4|(n[++d]&3)<<12,W=n[d]>>2|n[++d]<<6):(C|=n[++d]<<4|(n[++d]&63)<<12,W=n[d]>>6|n[++d]<<2|n[++d]<<10)),++d;var w=a?a.subarray(i.y,i.y+i.m):new V(i.m),H=w.length-C;if(X==0)w.set(n.subarray(d,d+=C),H);else if(X==1)Xe(w,n[d++],H);else{var D=i.h;if(X==2){var F=bn(n,d);W+=d-(d=F[0]),i.h=D=F[1]}else D||E(0);(J?Sn:He)(n.subarray(d,d+=W),w.subarray(H),D)}var z=n[d++];if(z){z==255?z=(n[d++]|n[d++]<<8)+32512:z>127&&(z=z-128<<8|n[d++]);var O=n[d++];O&3&&E(0);for(var R=[Tn,jn,_n],p=2;p>-1;--p){var L=O>>(p<<1)+2&3;if(L==1){var x=new V([0,0,n[d++]]);R[p]={s:x.subarray(2,3),n:x.subarray(0,1),t:new Ge(x.buffer,0,1),b:0}}else L==2?(u=ze(n,d,9-(p&1)),d=u[0],R[p]=u[1]):L==3&&(i.t||E(0),R[p]=i.t[p])}var k=i.t=R,M=k[0],I=k[1],B=k[2],N=n[P-1];N||E(0);var _=(P<<3)-8+le(N)-B.b,m=_>>3,Y=0,de=(n[m]|n[m+1]<<8)>>(_&7)&(1<<B.b)-1;m=(_-=I.b)>>3;var fe=(n[m]|n[m+1]<<8)>>(_&7)&(1<<I.b)-1;m=(_-=M.b)>>3;var ce=(n[m]|n[m+1]<<8)>>(_&7)&(1<<M.b)-1;for(++z;--z;){var $e=B.s[de],Re=B.n[de],me=M.s[ce],we=M.n[ce],ge=I.s[fe],Pe=I.n[fe];m=(_-=ge)>>3;var be=1<<ge,G=be+((n[m]|n[m+1]<<8|n[m+2]<<16|n[m+3]<<24)>>>(_&7)&be-1);m=(_-=tr[me])>>3;var ie=Fn[me]+((n[m]|n[m+1]<<8|n[m+2]<<16)>>(_&7)&(1<<tr[me])-1);m=(_-=rr[$e])>>3;var se=Cn[$e]+((n[m]|n[m+1]<<8|n[m+2]<<16)>>(_&7)&(1<<rr[$e])-1);if(m=(_-=Re)>>3,de=B.t[de]+((n[m]|n[m+1]<<8)>>(_&7)&(1<<Re)-1),m=(_-=we)>>3,ce=M.t[ce]+((n[m]|n[m+1]<<8)>>(_&7)&(1<<we)-1),m=(_-=Pe)>>3,fe=I.t[fe]+((n[m]|n[m+1]<<8)>>(_&7)&(1<<Pe)-1),G>3)i.o[2]=i.o[1],i.o[1]=i.o[0],i.o[0]=G-=3;else{var ne=G-(se!=0);ne?(G=ne==3?i.o[0]-1:i.o[ne],ne>1&&(i.o[2]=i.o[1]),i.o[1]=i.o[0],i.o[0]=G):G=i.o[0]}for(var p=0;p<se;++p)w[Y+p]=w[H+p];Y+=se,H+=se;var oe=Y-G;if(oe<0){var ue=-oe,Ve=i.e+oe;ue>ie&&(ue=ie);for(var p=0;p<ue;++p)w[Y+p]=i.w[Ve+p];Y+=ue,ie-=ue,oe=0}for(var p=0;p<ie;++p)w[Y+p]=w[oe+p];Y+=ie}if(Y!=H)for(;H<w.length;)w[Y++]=w[H++];else Y=w.length;a?i.y+=Y:w=er(w,0,Y)}else if(a){if(i.y+=C,H)for(var p=0;p<C;++p)w[p]=w[H+p]}else H&&(w=er(w,H));return i.b=P,w}E(2)}},Hn=function(n,i){if(n.length==1)return n[0];for(var a=new V(i),u=0,d=0;u<n.length;++u){var v=n[u];a.set(v,d),d+=v.length}return a};function Xn(n,i){for(var a=[],u=+!i,d=0,v=0;n.length;){var y=Pn(n,u||i);if(typeof y=="object"){for(u?(i=null,y.w.length==y.u&&(a.push(i=y.w),v+=y.u)):(a.push(i),y.e=0);!y.l;){var g=Wn(n,y,i);g||E(5),i?y.e=y.y:(a.push(g),v+=g.length,mn(y.w,0,g.length),y.w.set(g,y.w.length-g.length))}d=y.b+y.c*4}else d=y;n=n.subarray(d)}return Hn(a,v)}async function zn(n={}){var i,a=n,u=(e,r)=>{throw r},d="",v="";function y(e){return v+e}var g,P,j=console.log.bind(console),X=console.error.bind(console),b,C=!1,W,J=e=>e.startsWith("file://"),w,H,D,F,z,O,R,p,L,x,k=!1;function M(){var e=xe.buffer;D=new Int8Array(e),z=new Int16Array(e),a.HEAPU8=F=new Uint8Array(e),O=new Uint16Array(e),R=new Int32Array(e),p=new Uint32Array(e),L=new Float32Array(e),x=new Float64Array(e)}function I(){}function B(){k=!0,Fe.x()}function N(){}function _(e){e="Aborted("+e+")",X(e),C=!0,e+=". Build with -sASSERTIONS for more info.",k&&Cr();var r=new WebAssembly.RuntimeError(e);throw H?.(r),r}var m;let Y=()=>"";function de(e){if(e==m&&b)return new Uint8Array(b);if(P)return P(e);throw"both async and sync fetching of the wasm failed"}async function fe(e){if(!b)try{var r=await g(e);return new Uint8Array(r)}catch{}return de(e)}async function ce(e,r){try{var t=await fe(e),s=await WebAssembly.instantiate(t,r);return s}catch(o){X(`failed to asynchronously prepare wasm: ${o}`),_(o)}}async function $e(e,r,t){if(!e&&!J(r))try{var s=fetch(r,{credentials:"same-origin"}),o=await WebAssembly.instantiateStreaming(s,t);return o}catch(l){X(`wasm streaming compile failed: ${l}`),X("falling back to ArrayBuffer instantiation")}return ce(r,t)}function Re(){var e={a:hn};return e}async function me(){function e(l,c){return Fe=l.exports,cn(Fe),M(),Fe}function r(l){return e(l.instance)}var t=Re();m??=Y();var s=await $e(b,m,t),o=r(s);return o}class we{name="ExitStatus";constructor(r){this.message=`Program terminated with exit(${r})`,this.status=r}}var ge=globalThis.TextDecoder&&new TextDecoder,Pe=(e,r,t,s)=>{var o=r+t;if(s)return o;for(;e[r]&&!(r>=o);)++r;return r},be=(e,r=0,t,s)=>{var o=Pe(e,r,t,s);if(o-r>16&&e.buffer&&ge)return ge.decode(e.subarray(r,o));for(var l="";r<o;){var c=e[r++];if(!(c&128)){l+=String.fromCharCode(c);continue}var f=e[r++]&63;if((c&224)==192){l+=String.fromCharCode((c&31)<<6|f);continue}var h=e[r++]&63;if((c&240)==224?c=(c&15)<<12|f<<6|h:c=(c&7)<<18|f<<12|h<<6|e[r++]&63,c<65536)l+=String.fromCharCode(c);else{var $=c-65536;l+=String.fromCharCode(55296|$>>10,56320|$&1023)}}return l},G=(e,r,t)=>e?be(F,e,r,t):"",ie=(e,r,t,s)=>_(`Assertion failed: ${G(e)}, at: `+[r?G(r):"unknown filename",t,s?G(s):"unknown function"]),se=()=>Vr,ne=e=>{var r=e.getArg(se(),0);return zr(r)},oe=()=>Wr(),ue=e=>Fr(e),Ve=e=>Sr(e),xr=e=>{var r=oe(),t=Ve(4),s=Ve(4);Rr(e,t,s);var o=p[t>>2],l=p[s>>2],c=G(o);A(o);var f;return l&&(f=G(l),A(l)),ue(r),[c,f]},ar=e=>{var r=ne(e);return xr(r)},Gr=e=>{var r=new WebAssembly.Exception(se(),[e],{traceStack:!0});throw r.message=ar(r),r},Dr=()=>_(""),Or=(e,r,t,s,o)=>{},q=e=>{for(var r="";;){var t=F[e++];if(!t)return r;r+=String.fromCharCode(t)}},he={},pe={},Ue={},_e=class extends Error{constructor(e){super(e),this.name="BindingError"}},T=e=>{throw new _e(e)};function kr(e,r,t={}){var s=r.name;if(e||T(`type "${s}" must have a positive integer typeid pointer`),pe.hasOwnProperty(e)){if(t.ignoreDuplicateRegistrations)return;T(`Cannot register type '${s}' twice`)}if(pe[e]=r,delete Ue[e],he.hasOwnProperty(e)){var o=he[e];delete he[e],o.forEach(l=>l())}}function te(e,r,t={}){return kr(e,r,t)}var Zr=(e,r,t,s)=>{r=q(r),te(e,{name:r,fromWireType:function(o){return!!o},toWireType:function(o,l){return l?t:s},readValueFromPointer:function(o){return this.fromWireType(F[o])},destructorFunction:null})},Qr=e=>({count:e.count,deleteScheduled:e.deleteScheduled,preservePointerOnDelete:e.preservePointerOnDelete,ptr:e.ptr,ptrType:e.ptrType,smartPtr:e.smartPtr,smartPtrType:e.smartPtrType}),Oe=e=>{function r(t){return t.$$.ptrType.registeredClass.name}T(r(e)+" instance already deleted")},ke=!1,ir=e=>{},Br=e=>{e.smartPtr?e.smartPtrType.rawDestructor(e.smartPtr):e.ptrType.registeredClass.rawDestructor(e.ptr)},sr=e=>{e.count.value-=1;var r=e.count.value===0;r&&Br(e)},Te=e=>globalThis.FinalizationRegistry?(ke=new FinalizationRegistry(r=>{sr(r.$$)}),Te=r=>{var t=r.$$,s=!!t.smartPtr;if(s){var o={$$:t};ke.register(r,o,r)}return r},ir=r=>ke.unregister(r),Te(e)):(Te=r=>r,e),Ee=[],Nr=()=>{for(;Ee.length;){var e=Ee.pop();e.$$.deleteScheduled=!1,e.delete()}},or,Ir=()=>{let e=Le.prototype;Object.assign(e,{isAliasOf(t){if(!(this instanceof Le)||!(t instanceof Le))return!1;var s=this.$$.ptrType.registeredClass,o=this.$$.ptr;t.$$=t.$$;for(var l=t.$$.ptrType.registeredClass,c=t.$$.ptr;s.baseClass;)o=s.upcast(o),s=s.baseClass;for(;l.baseClass;)c=l.upcast(c),l=l.baseClass;return s===l&&o===c},clone(){if(this.$$.ptr||Oe(this),this.$$.preservePointerOnDelete)return this.$$.count.value+=1,this;var t=Te(Object.create(Object.getPrototypeOf(this),{$$:{value:Qr(this.$$)}}));return t.$$.count.value+=1,t.$$.deleteScheduled=!1,t},delete(){this.$$.ptr||Oe(this),this.$$.deleteScheduled&&!this.$$.preservePointerOnDelete&&T("Object already scheduled for deletion"),ir(this),sr(this.$$),this.$$.preservePointerOnDelete||(this.$$.smartPtr=void 0,this.$$.ptr=void 0)},isDeleted(){return!this.$$.ptr},deleteLater(){return this.$$.ptr||Oe(this),this.$$.deleteScheduled&&!this.$$.preservePointerOnDelete&&T("Object already scheduled for deletion"),Ee.push(this),Ee.length===1&&or&&or(Nr),this.$$.deleteScheduled=!0,this}});let r=Symbol.dispose;r&&(e[r]=e.delete)};function Le(){}var ur=(e,r)=>Object.defineProperty(r,"name",{value:e}),lr={},dr=(e,r,t)=>{if(e[r].overloadTable===void 0){var s=e[r];e[r]=function(...o){return e[r].overloadTable.hasOwnProperty(o.length)||T(`Function '${t}' called with an invalid number of arguments (${o.length}) - expects one of (${e[r].overloadTable})!`),e[r].overloadTable[o.length].apply(this,o)},e[r].overloadTable=[],e[r].overloadTable[s.argCount]=s}},qr=(e,r,t)=>{a.hasOwnProperty(e)?((t===void 0||a[e].overloadTable!==void 0&&a[e].overloadTable[t]!==void 0)&&T(`Cannot register public name '${e}' twice`),dr(a,e,e),a[e].overloadTable.hasOwnProperty(t)&&T(`Cannot register multiple overloads of a function with the same number of arguments (${t})!`),a[e].overloadTable[t]=r):(a[e]=r,a[e].argCount=t)},Ar=48,et=57,rt=e=>{e=e.replace(/[^a-zA-Z0-9_]/g,"$");var r=e.charCodeAt(0);return r>=Ar&&r<=et?`_${e}`:e};function tt(e,r,t,s,o,l,c,f){this.name=e,this.constructor=r,this.instancePrototype=t,this.rawDestructor=s,this.baseClass=o,this.getActualType=l,this.upcast=c,this.downcast=f,this.pureVirtualFunctions=[]}var Ze=(e,r,t)=>{for(;r!==t;)r.upcast||T(`Expected null or instance of ${t.name}, got an instance of ${r.name}`),e=r.upcast(e),r=r.baseClass;return e},Qe=e=>{if(e===null)return"null";var r=typeof e;return r==="object"||r==="array"||r==="function"?e.toString():""+e};function nt(e,r){if(r===null)return this.isReference&&T(`null is not a valid ${this.name}`),0;r.$$||T(`Cannot pass "${Qe(r)}" as a ${this.name}`),r.$$.ptr||T(`Cannot pass deleted object as a pointer of type ${this.name}`);var t=r.$$.ptrType.registeredClass,s=Ze(r.$$.ptr,t,this.registeredClass);return s}function at(e,r){var t;if(r===null)return this.isReference&&T(`null is not a valid ${this.name}`),this.isSmartPointer?(t=this.rawConstructor(),e!==null&&e.push(this.rawDestructor,t),t):0;(!r||!r.$$)&&T(`Cannot pass "${Qe(r)}" as a ${this.name}`),r.$$.ptr||T(`Cannot pass deleted object as a pointer of type ${this.name}`),!this.isConst&&r.$$.ptrType.isConst&&T(`Cannot convert argument of type ${r.$$.smartPtrType?r.$$.smartPtrType.name:r.$$.ptrType.name} to parameter type ${this.name}`);var s=r.$$.ptrType.registeredClass;if(t=Ze(r.$$.ptr,s,this.registeredClass),this.isSmartPointer)switch(r.$$.smartPtr===void 0&&T("Passing raw pointer to smart pointer is illegal"),this.sharingPolicy){case 0:r.$$.smartPtrType===this?t=r.$$.smartPtr:T(`Cannot convert argument of type ${r.$$.smartPtrType?r.$$.smartPtrType.name:r.$$.ptrType.name} to parameter type ${this.name}`);break;case 1:t=r.$$.smartPtr;break;case 2:if(r.$$.smartPtrType===this)t=r.$$.smartPtr;else{var o=r.clone();t=this.rawShare(t,Ne.toHandle(()=>o.delete())),e!==null&&e.push(this.rawDestructor,t)}break;default:T("Unsupported sharing policy")}return t}function it(e,r){if(r===null)return this.isReference&&T(`null is not a valid ${this.name}`),0;r.$$||T(`Cannot pass "${Qe(r)}" as a ${this.name}`),r.$$.ptr||T(`Cannot pass deleted object as a pointer of type ${this.name}`),r.$$.ptrType.isConst&&T(`Cannot convert argument of type ${r.$$.ptrType.name} to parameter type ${this.name}`);var t=r.$$.ptrType.registeredClass,s=Ze(r.$$.ptr,t,this.registeredClass);return s}function Me(e){return this.fromWireType(p[e>>2])}var fr=(e,r,t)=>{if(r===t)return e;if(t.baseClass===void 0)return null;var s=fr(e,r,t.baseClass);return s===null?null:t.downcast(s)},st={},ot=(e,r)=>{for(r===void 0&&T("ptr should not be undefined");e.baseClass;)r=e.upcast(r),e=e.baseClass;return r},ut=(e,r)=>(r=ot(e,r),st[r]),lt=class extends Error{constructor(e){super(e),this.name="InternalError"}},Ke=e=>{throw new lt(e)},Je=(e,r)=>{(!r.ptrType||!r.ptr)&&Ke("makeClassHandle requires ptr and ptrType");var t=!!r.smartPtrType,s=!!r.smartPtr;return t!==s&&Ke("Both smartPtrType and smartPtr must be specified"),r.count={value:1},Te(Object.create(e,{$$:{value:r,writable:!0}}))};function dt(e){var r=this.getPointee(e);if(!r)return this.destructor(e),null;var t=ut(this.registeredClass,r);if(t!==void 0){if(t.$$.count.value===0)return t.$$.ptr=r,t.$$.smartPtr=e,t.clone();var s=t.clone();return this.destructor(e),s}function o(){return this.isSmartPointer?Je(this.registeredClass.instancePrototype,{ptrType:this.pointeeType,ptr:r,smartPtrType:this,smartPtr:e}):Je(this.registeredClass.instancePrototype,{ptrType:this,ptr:e})}var l=this.registeredClass.getActualType(r),c=lr[l];if(!c)return o.call(this);var f;this.isConst?f=c.constPointerType:f=c.pointerType;var h=fr(r,this.registeredClass,f.registeredClass);return h===null?o.call(this):this.isSmartPointer?Je(f.registeredClass.instancePrototype,{ptrType:f,ptr:h,smartPtrType:this,smartPtr:e}):Je(f.registeredClass.instancePrototype,{ptrType:f,ptr:h})}var ft=()=>{Object.assign(Ye.prototype,{getPointee(e){return this.rawGetPointee&&(e=this.rawGetPointee(e)),e},destructor(e){this.rawDestructor?.(e)},readValueFromPointer:Me,fromWireType:dt})};function Ye(e,r,t,s,o,l,c,f,h,$,S){this.name=e,this.registeredClass=r,this.isReference=t,this.isConst=s,this.isSmartPointer=o,this.pointeeType=l,this.sharingPolicy=c,this.rawGetPointee=f,this.rawConstructor=h,this.rawShare=$,this.rawDestructor=S,!o&&r.baseClass===void 0?s?(this.toWireType=nt,this.destructorFunction=null):(this.toWireType=it,this.destructorFunction=null):this.toWireType=at}var ct=(e,r,t)=>{a.hasOwnProperty(e)||Ke("Replacing nonexistent public symbol"),a[e].overloadTable!==void 0&&t!==void 0?a[e].overloadTable[t]=r:(a[e]=r,a[e].argCount=t)},cr={},ht=(e,r,t)=>{e=e.replace(/p/g,"i");var s=cr[e];return s(r,...t)},hr=e=>Ur.get(e),pt=(e,r,t=[],s=!1)=>{if(e.includes("j"))return ht(e,r,t);var o=hr(r),l=o(...t);function c(f){return f}return l},yt=(e,r,t=!1)=>(...s)=>pt(e,r,s,t),ye=(e,r,t=!1)=>{e=q(e);function s(){if(e.includes("j"))return yt(e,r);var l=hr(r);return l}var o=s();return typeof o!="function"&&T(`unknown function pointer with signature ${e}: ${r}`),o};class vt extends Error{}var $t=e=>{var r=Tr(e),t=q(r);return A(r),t},Be=(e,r)=>{var t=[],s={};function o(l){if(!s[l]&&!pe[l]){if(Ue[l]){Ue[l].forEach(o);return}t.push(l),s[l]=!0}}throw r.forEach(o),new vt(`${e}: `+t.map($t).join([", "]))},je=(e,r,t)=>{e.forEach(f=>Ue[f]=r);function s(f){var h=t(f);h.length!==e.length&&Ke("Mismatched type converter count");for(var $=0;$<e.length;++$)te(e[$],h[$])}var o=new Array(r.length),l=[],c=0;for(let[f,h]of r.entries())pe.hasOwnProperty(h)?o[f]=pe[h]:(l.push(h),he.hasOwnProperty(h)||(he[h]=[]),he[h].push(()=>{o[f]=pe[h],++c,c===l.length&&s(o)}));l.length===0&&s(o)},mt=(e,r,t,s,o,l,c,f,h,$,S,K,Z)=>{S=q(S),l=ye(o,l),f&&=ye(c,f),$&&=ye(h,$),Z=ye(K,Z);var U=rt(S);qr(U,function(){Be(`Cannot construct ${S} due to unbound types`,[s])}),je([e,r,t],s?[s]:[],Q=>{Q=Q[0];var ee,Se;s?(ee=Q.registeredClass,Se=ee.instancePrototype):Se=Le.prototype;var ae=ur(S,function(...Ae){if(Object.getPrototypeOf(this)!==qe)throw new _e(`Use 'new' to construct ${S}`);if(re.constructor_body===void 0)throw new _e(`${S} has no accessible constructor`);var Mr=re.constructor_body[Ae.length];if(Mr===void 0)throw new _e(`Tried to invoke ctor of ${S} with invalid number of parameters (${Ae.length}) - expected (${Object.keys(re.constructor_body).toString()}) parameters instead!`);return Mr.apply(this,Ae)}),qe=Object.create(Se,{constructor:{value:ae}});ae.prototype=qe;var re=new tt(S,ae,qe,Z,ee,l,f,$);re.baseClass&&(re.baseClass.__derivedClasses??=[],re.baseClass.__derivedClasses.push(re));var yn=new Ye(S,re,!0,!1,!1),Er=new Ye(S+"*",re,!1,!1,!1),Lr=new Ye(S+" const*",re,!1,!0,!1);return lr[e]={pointerType:Er,constPointerType:Lr},ct(U,ae),[yn,Er,Lr]})},pr=(e,r)=>{for(var t=[],s=0;s<e;s++)t.push(p[r+s*4>>2]);return t},wt=e=>{for(;e.length;){var r=e.pop(),t=e.pop();t(r)}};function yr(e){for(var r=1;r<e.length;++r)if(e[r]!==null&&e[r].destructorFunction===void 0)return!0;return!1}function gt(e,r,t,s){var o=yr(e),l=e.length-2,c=[],f=["fn"];r&&f.push("thisWired");for(var h=0;h<l;++h)c.push(`arg${h}`),f.push(`arg${h}Wired`);c=c.join(","),f=f.join(",");var $=`return function (${c}) {
`;o&&($+=`var destructors = [];
